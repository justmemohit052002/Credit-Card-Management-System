...
Creates Hibernate sessions that interact with the database.

Transaction Manager

Manages database transactions to ensure consistency and reliability.

🗄 Database Tables

Hibernate automatically creates the following tables in MySQL:

Table	Description
Customer	Stores customer information
CreditCard	Stores credit card details
Transaction	Stores transaction history
Bill	Stores billing details
...
CREATE DATABASE credit_card_management_db;
...
The console menu will appear, allowing you to perform operations.
...
By building this project, the following concepts were learned:
